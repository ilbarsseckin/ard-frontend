  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-10 md:py-14">
        ...
        {/* CTA */}
        <div
          className="mb-10 md:mb-14 p-6 md:p-8 rounded-3xl"
          style={{
            background:
              'linear-gradient(135deg, rgba(244,130,31,.12), rgba(244,130,31,.03))',
        ...
        >
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div>
              ...
              >
                Kartvizit, Broşür, Sticker, Bayrak, Promosyon Ürünleri ve
            ...
            <Link
              ...
              style={{
                background:
                  'linear-gradient(135deg,#F4821F,#ff9f47)',
              }}
            >
              Ürünleri İncele
              <ArrowRight size={18} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item}>
                  <Link
                    href={`/urunler?q=${encodeURIComponent(
                      item.toLowerCase()
                    )}`}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              >
                <Mail size={18} />
                <a
                  href="mailto:info@baskiurunleri.com"
                  className="hover:text-[#F4821F]"
                >
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-5">
            <Link
              href="/gizlilik"
              className="text-xs hover:text-[#F4821F]"
              style={{ color: 'var(--text-muted)' }}
            >
              Gizlilik Politikası
            </Link>
