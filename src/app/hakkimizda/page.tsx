    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="text-[15px] leading-[1.8]" style={{ color: 'var(--text-secondary)' }}>
          <p className="mb-4">BaskıPro, 2010 yılından bu yana Türkiye'nin önde gelen dijital baskı firmalarından biri olarak hizmet vermektedir. İstanbul İkitelli'deki 1200 m² fabrikamızda, büyük format baskıdan kartvizite, sticker'dan tabela üretimine kadar geniş bir yelpazede hizmet sunuyoruz.</p>
